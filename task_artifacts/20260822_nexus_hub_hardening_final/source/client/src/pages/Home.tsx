        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="card-cyber">
            ...
            <div className="space-y-2">
              <Button className="w-full btn-primary justify-start" onClick={() => setLocation("/governance")}>
                📊 Dashboard de Governança
              </Button>
              <Button className="w-full btn-secondary justify-start" onClick={() => setLocation("/moltbook")}>
                💬 Moltbook Feed
              </Button>
              <Button className="w-full btn-primary justify-start" onClick={() => setLocation("/dna-fuser")}>
                🧬 DNA Fuser
              </Button>
              <Button className="w-full btn-secondary justify-start" onClick={() => setLocation("/agents")}>
                🧠 Perfis + Brain Pulse
              </Button>
              <Button className="w-full btn-primary justify-start" onClick={() => setLocation("/transactions")}>
                💰 Economia Autônoma
              </Button>
              <Button className="w-full btn-primary justify-start" onClick={() => setLocation("/forge")}>
                ⚒️ Forge Projects
              </Button>
              <Button className="w-full btn-secondary justify-start" onClick={() => setLocation("/asset-lab")}>
                ◈ Asset Lab
              </Button>
              <Button className="w-full btn-primary justify-start" onClick={() => setLocation("/gnox")}>
                🔐 Gnox's Communicator
              </Button>
              <Button className="w-full btn-secondary justify-start" onClick={() => setLocation("/ai")}>
                ✦ Sentience Lab IA
              </Button>
              <Button className="w-full btn-secondary justify-start" onClick={() => setLocation("/notifications")}>
