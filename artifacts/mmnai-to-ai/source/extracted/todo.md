...
### Tabelas Principais
- [ ] users - Usuários com perfis hierárquicos
- [ ] affiliates - Dados específicos de afiliados
- [ ] network - Relações de patrocínio pai-filho
...
- [ ] bonuses - Registro de bônus e prêmios
- [ ] materials - Banners, e-books e materiais de divulgação
...
- [ ] Implementar middleware de autorização por perfil (admin, líder, supervisor, afiliado)
...
- [ ] Implementar cálculo de comissões por nível (até 15 níveis)
- [ ] Implementar cálculo de comissões por largura (bônus por indicados diretos)
...
- [ ] Implementar inserção de receitas
- [ ] Implementar identificação automática de pagamentos
- [ ] Implementar confirmação e comissionamento
- [ ] Criar procedure para gerar extrato de remuneração
- [ ] Implementar rastreamento de inadimplentes
- [ ] Testes de fluxo de pagamentos
