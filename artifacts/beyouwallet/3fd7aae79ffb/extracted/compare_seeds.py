...
def mn_decode(words, wordlist):
    ...
    return hex(out)[2:].rstrip('L')

phrase_11 = "fly come chick true clear another king fear raise third down"
words_11 = phrase_11.split()
seed_11 = mn_decode(words_11, user_wordlist)
provided_seed = "9d087b7cc9a85f048d59eb50666ea70c"

print(f"Seed das 11 palavras (hex): {seed_11}")
print(f"Seed fornecida (hex):      {provided_seed}")
