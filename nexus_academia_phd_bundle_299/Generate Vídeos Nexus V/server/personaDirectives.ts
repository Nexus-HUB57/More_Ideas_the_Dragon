...
export const COURSE_MODULES = {
  fundamental: {
    ...
    modules: [
      ...
      { id: "04", title: "Primeiros Passos na Plataforma", duration: "15 min" },
      { id: "05", title: "Navegando pelo Dashboard", duration: "15 min" },
    ],
  },
  agente: {
    level: "Agente",
    ...
    certifications: [
      { id: "CAN", title: "Certificação Agente Nexus" },
    ],
    modules: [
      ...
      { id: "04", title: "Automação de Tarefas", duration: "20 min" },
    ],
  },
  master: {
    level: "Master",
    ...
    modules: [
      ...
      { id: "04", title: "Estratégias de Escala", duration: "25 min" },
    ],
  },
  elite: {
    level: "Elite",
    ...
    certifications: [
      { id: "CMA", title: "Certificação Master Nexus" },
    ],
    certifications: [
      { id: "CMA", title: "Certificação Master Nexus" },
    ],
    modules: [
      ...
      { id: "03", title: "Governança e Compliance", duration: "25 min" },
    ],
  },
};
