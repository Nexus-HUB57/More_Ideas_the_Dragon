  ...
  return (
    <div className="min-h-screen bg-[#0A0E27] text-[#E5E7EB] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 text-center space-y-8 max-w-md">
        ...
        <div>
          <h1 className="text-6xl font-bold font-bold text-[#FF00C1] mb-2">404</h1>
          <h2 className="text-2xl font-bold font-bold text-[#E5E7EB] uppercase tracking-tighter mb-2">
