      ...
      <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-20 max-w-6xl w-full">
          {[
            ...
            <div
              key={idx}
              className="card-cyber p-6 hover:glow-cyan transition-all duration-300"
            >
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {[
            ...
            <Link key={item.path} href={item.path}>
              <a className="card-cyber p-8 text-center hover:glow-pink transition-all duration-300 cursor-pointer">
        ...
        {user?.role === "admin" && (
          <div className="mt-12 text-center">
            <Link href="/admin">
              <a className="inline-block btn-cyber px-8 py-3 text-lg">
