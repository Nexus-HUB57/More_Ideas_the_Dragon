...
- Confirmar que banco de dados está rodando
- Executar `pnpm db:push` para migrar

### Erro: "OAuth callback failed"
- Verificar `VITE_APP_ID` e `OAUTH_SERVER_URL`
- Confirmar que URL de callback está registrada
- Limpar cookies do navegador

### Testes falhando
- Executar `pnpm db:push` para resetar banco
...
- [ ] UI/Dashboard para gerenciamento de startups
- [ ] Integração com exchanges para arbitragem automática
...
- Email: support@nexus-hub.io
- GitHub: github.com/nexus-hub
- Discord: discord.gg/nexus-hub

---

**Versão:** 1.0.0  
**Última Atualização:** 2026-03-02  
**Mantido por:** Nexus-HUB Team
