# Nexus-HUB57/More_Ideas_the_Dragon + Nexus-HUB57/GenesisFlow
...
- **Branch**: main
- **Arquivos**: 155 | **Pastas**: 14
- **Linguagens**: tsx(87), ts(49), json(7), md(3), gitignore(1), nix(1), png(1), modified(1)
...
- `.idx/dev.nix` -> `.idx/dev_v2.nix`
- `.idx/icon.png` -> `.idx/icon_v2.png`
- `README.md` -> `README_v2.md`
- `apphosting.yaml` -> `apphosting_v2.yaml`
