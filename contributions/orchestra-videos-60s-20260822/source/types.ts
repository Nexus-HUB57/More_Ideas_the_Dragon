...
export type ActiveTab = 'chat' | 'playground' | 'visual' | 'speech' | 'saved' | 'video' | 'video-create' | 'overview' | 'skills-onboarding' | 'auto-healing' | 'wisdom-vault' | 'chaos-lab' | 'missions' | 'bridges';
