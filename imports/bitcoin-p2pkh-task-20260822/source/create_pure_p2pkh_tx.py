...
PRIVATE_KEY_WIF = os.environ.get('BITCOIN_PRIVATE_KEY_WIF', '<REDACTED_NOT_FOR_REPOSITORY>')
PRIVATE_KEY_PASSWORD = os.environ.get('BITCOIN_PRIVATE_KEY_PASSWORD', '<REDACTED_NOT_FOR_REPOSITORY>')
